...
replace (
	github.com/golangci/golangci-lint => github.com/kamilsk/golangci-lint v1.45.2
	golang.org/x/tools => github.com/kamilsk/go-tools v0.1.10
)

// TODO:remove by golangci-lint update
